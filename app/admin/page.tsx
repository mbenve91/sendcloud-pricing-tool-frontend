...
import { Activity, Package, Truck, Tag, Clock, AlertTriangle, CheckCircle2 } from "lucide-react"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Rate distribution across carriers and services</CardDescription>
              </CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Services awaiting rate updates</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Services with pricing discrepancies</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Services with optimal margins</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
